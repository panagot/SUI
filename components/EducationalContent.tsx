          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600 dark:text-slate-400">
                • <strong>Sui&apos;s Object Model:</strong> Unlike other blockchains, Sui uses objects instead of accounts
              </p>
              <p className="text-slate-600 dark:text-slate-400">
                • <strong>Gas Efficiency:</strong> Sui&apos;s unique gas model can make transactions profitable through storage rebates
              </p>
              <p className="text-slate-600 dark:text-slate-400">
                • <strong>Parallel Execution:</strong> Sui can process transactions in parallel, making it extremely fast
              </p>
              <p className="text-slate-600 dark:text-slate-400">
                • <strong>Move Language:</strong> Sui uses Move, a safe and efficient programming language for smart contracts
              </p>
            </div>
          </div>
        </div>
